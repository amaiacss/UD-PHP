	...
	<div class="container-fluid">
		...
		<div class="container py-5">
			...
			<?php 
				...
				#LISTA BLANCA, se valora si la variable pagina existe y es equivalente a alguno de estos valores, solo entonces mostrará la página que corresponde, sino mostrará 404

				#SEGURIDAD, de esta forma controlamos las única páginas a las que puede entrar al usuario, y no que en la barra del navegador se pueda sustituir despues del =, pagina =, y ponga un script que se pueda ejecutar
